...
namespace _20S2_5032_A2_4.Controllers
{
    public class doctorsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,f_name,l_name,email,phone")] doctor doctor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,f_name,l_name,email,phone")] doctor doctor)
        {
            if (ModelState.IsValid)
            {
