...
namespace _20S2_5032_A2_4.Controllers
{
    public class patientsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,f_name,l_name,address,phone,email")] patient patient)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,f_name,l_name,address,phone,email")] patient patient)
        {
            if (ModelState.IsValid)
            {
